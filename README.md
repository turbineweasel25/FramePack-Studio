...
- **Metadata Saving**: Prompt and seed are encoded into the initial PNG in the ouput folder all other generation metadata is saved in a JSON file for easier importing
